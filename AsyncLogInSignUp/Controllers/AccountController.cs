...
namespace AsyncLogInSignUp.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);  -- It's commented, because we will send a verification link. After verification he/she need to login again.
                ...
                if (result.Errors.Count() > 0)
                    return Json(result.Errors.ToArray(), JsonRequestBehavior.AllowGet);
            }
